...
[ExcludeClass]
internal class _IndicesFinancieros2DatatypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id_formula", "NOMBRE", "rangos_desc", "rango_superior", "DESCRIPCION", "formula_desc", "decimales", "campo3", "campo2", "campo5", "campo4", "ID_GRUPO_INDICE_FINANCIERO", "rango_inferior", "campo1", "ID_INDICE_FINANCIERO", "formula");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id_formula", "NOMBRE", "rangos_desc", "rango_superior", "DESCRIPCION", "formula_desc", "decimales", "campo3", "campo2", "campo5", "campo4", "ID_GRUPO_INDICE_FINANCIERO", "rango_inferior", "campo1", "ID_INDICE_FINANCIERO", "formula");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id_formula", "NOMBRE", "rangos_desc", "rango_superior", "DESCRIPCION", "formula_desc", "decimales", "campo3", "campo2", "campo5", "campo4", "ID_GRUPO_INDICE_FINANCIERO", "rango_inferior", "campo1", "ID_INDICE_FINANCIERO", "formula");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id_formula", "NOMBRE", "rangos_desc", "rango_superior", "DESCRIPCION", "formula_desc", "decimales", "campo3", "campo2", "campo5", "campo4", "ID_GRUPO_INDICE_FINANCIERO", "rango_inferior", "campo1", "ID_INDICE_FINANCIERO", "formula");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id_formula", "NOMBRE", "rangos_desc", "rango_superior", "DESCRIPCION", "formula_desc", "decimales", "campo3", "campo2", "campo5", "campo4", "ID_GRUPO_INDICE_FINANCIERO", "rango_inferior", "campo1", "ID_INDICE_FINANCIERO", "formula");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "IndicesFinancieros2Datatype";
    ...
    public function _IndicesFinancieros2DatatypeEntityMetadata(value : _Super_IndicesFinancieros2Datatype)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity IndicesFinancieros2Datatype");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity IndicesFinancieros2Datatype");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of IndicesFinancieros2Datatype");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity IndicesFinancieros2Datatype");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity IndicesFinancieros2Datatype");
        }
