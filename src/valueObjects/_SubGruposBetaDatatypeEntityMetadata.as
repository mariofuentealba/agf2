...
[ExcludeClass]
internal class _SubGruposBetaDatatypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("nombre", "ID_SUBGRUPO", "ID_TIPO_EMPRESA", "descripcion");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("nombre", "ID_SUBGRUPO", "ID_TIPO_EMPRESA", "descripcion");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("nombre", "ID_SUBGRUPO", "ID_TIPO_EMPRESA", "descripcion");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("nombre", "ID_SUBGRUPO", "ID_TIPO_EMPRESA", "descripcion");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("nombre", "ID_SUBGRUPO", "ID_TIPO_EMPRESA", "descripcion");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "SubGruposBetaDatatype";
    ...
    model_internal var _ID_SUBGRUPOIsValid:Boolean;
    model_internal var _ID_SUBGRUPOValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ID_SUBGRUPOIsValidCacheInitialized:Boolean = false;
    model_internal var _ID_SUBGRUPOValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_SubGruposBetaDatatype;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _SubGruposBetaDatatypeEntityMetadata(value : _Super_SubGruposBetaDatatype)
    {
        ...
        model_internal::_ID_SUBGRUPOValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForID_SUBGRUPO);
        model_internal::_ID_SUBGRUPOValidator.required = true;
        model_internal::_ID_SUBGRUPOValidator.requiredFieldError = "ID_SUBGRUPO is required";
        //model_internal::_ID_SUBGRUPOValidator.source = model_internal::_instance;
        //model_internal::_ID_SUBGRUPOValidator.property = "ID_SUBGRUPO";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity SubGruposBetaDatatype");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity SubGruposBetaDatatype");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of SubGruposBetaDatatype");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity SubGruposBetaDatatype");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity SubGruposBetaDatatype");
        }
    ...
    public function invalidateDependentOnID_SUBGRUPO():void
    {
        if (model_internal::_ID_SUBGRUPOIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfID_SUBGRUPO = null;
            model_internal::calculateID_SUBGRUPOIsValid();
        }
    }
    ...
    public function get ID_SUBGRUPOValidator() : StyleValidator
    {
        return model_internal::_ID_SUBGRUPOValidator;
    }

    model_internal function set _ID_SUBGRUPOIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ID_SUBGRUPOIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ID_SUBGRUPOIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ID_SUBGRUPOIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ID_SUBGRUPOIsValid():Boolean
    {
        if (!model_internal::_ID_SUBGRUPOIsValidCacheInitialized)
        {
            model_internal::calculateID_SUBGRUPOIsValid();
        ...
        return model_internal::_ID_SUBGRUPOIsValid;
    }

    model_internal function calculateID_SUBGRUPOIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ID_SUBGRUPOValidator.validate(model_internal::_instance.ID_SUBGRUPO)
        model_internal::_ID_SUBGRUPOIsValid_der = (valRes.results == null);
        model_internal::_ID_SUBGRUPOIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ID_SUBGRUPOValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ID_SUBGRUPOValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ID_SUBGRUPOValidationFailureMessages():Array
    {
        if (model_internal::_ID_SUBGRUPOValidationFailureMessages == null)
            model_internal::calculateID_SUBGRUPOIsValid();

        return _ID_SUBGRUPOValidationFailureMessages;
    }

    model_internal function set ID_SUBGRUPOValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ID_SUBGRUPOValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ID_SUBGRUPOValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ID_SUBGRUPOValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("ID_SUBGRUPO"):
            {
                return ID_SUBGRUPOValidationFailureMessages;
            }
