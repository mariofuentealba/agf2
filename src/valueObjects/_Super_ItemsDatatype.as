 ...
 * of this value object you may modify the generated sub-class of this class - ItemsDatatype.as.
 */
...
[ExcludeClass]
public class _Super_ItemsDatatype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ItemsDatatypeEntityMetadata;
    ...
    private var _internal_componente : String;
    ...
    public function _Super_ItemsDatatype()
    {
        _model = new _ItemsDatatypeEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "componente", model_internal::setterListenerComponente));
    ...
    {
        var oldValue:String = _internal_componente;
        if (oldValue !== value)
        {
            _internal_componente = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "componente", oldValue, _internal_componente));
        }
    }
    ...
    model_internal function setterListenerComponente(value:flash.events.Event):void
    {
        _model.invalidateDependentOnComponente();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.componenteIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_componenteValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ItemsDatatypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ItemsDatatypeEntityMetadata) : void
    {
        var oldValue : _ItemsDatatypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfComponente : Array = null;
    model_internal var _doValidationLastValOfComponente : String;

    model_internal function _doValidationForComponente(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfComponente != null && model_internal::_doValidationLastValOfComponente == value)
           return model_internal::_doValidationCacheOfComponente ;

        _model.model_internal::_componenteIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isComponenteAvailable && _internal_componente == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "componente is required"));
        }

        model_internal::_doValidationCacheOfComponente = validationFailures;
        model_internal::_doValidationLastValOfComponente = value;
