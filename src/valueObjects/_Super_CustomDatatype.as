...
public class _Super_CustomDatatype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_ID_TIPO_EMPRESA : int;
    ...
    public function get ID_TIPO_EMPRESA() : int
    {
    ...
    public function set ID_TIPO_EMPRESA(value:int) : void
    {
        var oldValue:int = _internal_ID_TIPO_EMPRESA;
        if (oldValue !== value)
        {
