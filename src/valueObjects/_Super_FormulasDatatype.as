...
public class _Super_FormulasDatatype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_campo4n : Object;
    ...
    private var _internal_sel : String;
    ...
    public function _Super_FormulasDatatype()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "sel", model_internal::setterListenerSel));
    ...
    [Bindable(event="propertyChange")]
    public function get campo3n() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get campo5n() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get campo4n() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get sel() : String
    {
        return _internal_sel;
    }
    ...
    public function set campo3n(value:Object) : void
    {
        var oldValue:Object = _internal_campo3n;
        if (oldValue !== value)
        {
    ...
    public function set campo5n(value:Object) : void
    {
        var oldValue:Object = _internal_campo5n;
        if (oldValue !== value)
        {
    ...
    public function set campo4n(value:Object) : void
    {
        var oldValue:Object = _internal_campo4n;
        if (oldValue !== value)
        {
    ...
    public function set sel(value:String) : void
    {
        var oldValue:String = _internal_sel;
        if (oldValue !== value)
        {
            _internal_sel = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "sel", oldValue, _internal_sel));
        }
    }
    ...
    model_internal function setterListenerSel(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSel();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.selIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_selValidationFailureMessages);
        }
    ...
    model_internal var _doValidationLastValOfCampo3n : Object;
    ...
    model_internal var _doValidationLastValOfCampo5n : Object;
    ...
    model_internal var _doValidationLastValOfCampo4n : Object;
    ...
    model_internal var _doValidationCacheOfSel : Array = null;
    model_internal var _doValidationLastValOfSel : String;

    model_internal function _doValidationForSel(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSel != null && model_internal::_doValidationLastValOfSel == value)
           return model_internal::_doValidationCacheOfSel ;

        _model.model_internal::_selIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSelAvailable && _internal_sel == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "sel is required"));
        }

        model_internal::_doValidationCacheOfSel = validationFailures;
        model_internal::_doValidationLastValOfSel = value;
