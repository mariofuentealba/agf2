...
internal class _RescataFormulaDatatypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("num_formula", "campo1n", "selected", "campo3n", "tipoc2", "id_indice_financiero", "tipoc1", "campo5n", "tipoc5", "tipoc4", "tipoc3", "id_formula", "campo2n", "campo4n", "campo3", "cod3", "campo2", "cod2", "campo5", "cod1", "campo4", "campo1", "cod5", "formula", "cod4");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("num_formula", "campo1n", "selected", "campo3n", "tipoc2", "id_indice_financiero", "tipoc1", "campo5n", "tipoc5", "tipoc4", "tipoc3", "id_formula", "campo2n", "campo4n", "campo3", "cod3", "campo2", "cod2", "campo5", "cod1", "campo4", "campo1", "cod5", "formula", "cod4");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("num_formula", "campo1n", "selected", "campo3n", "tipoc2", "id_indice_financiero", "tipoc1", "campo5n", "tipoc5", "tipoc4", "tipoc3", "id_formula", "campo2n", "campo4n", "campo3", "cod3", "campo2", "cod2", "campo5", "cod1", "campo4", "campo1", "cod5", "formula", "cod4");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("num_formula", "campo1n", "selected", "campo3n", "tipoc2", "id_indice_financiero", "tipoc1", "campo5n", "tipoc5", "tipoc4", "tipoc3", "id_formula", "campo2n", "campo4n", "campo3", "cod3", "campo2", "cod2", "campo5", "cod1", "campo4", "campo1", "cod5", "formula", "cod4");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("num_formula", "campo1n", "selected", "campo3n", "tipoc2", "id_indice_financiero", "tipoc1", "campo5n", "tipoc5", "tipoc4", "tipoc3", "id_formula", "campo2n", "campo4n", "campo3", "cod3", "campo2", "cod2", "campo5", "cod1", "campo4", "campo1", "cod5", "formula", "cod4");
    ...
    model_internal var _selectedIsValid:Boolean;
    model_internal var _selectedValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _selectedIsValidCacheInitialized:Boolean = false;
    model_internal var _selectedValidationFailureMessages:Array;
    ...
    public function _RescataFormulaDatatypeEntityMetadata(value : _Super_RescataFormulaDatatype)
    {
        ...
        model_internal::propertyTypeMap["selected"] = "String";
        model_internal::propertyTypeMap["campo3n"] = "String";
        ...
        model_internal::propertyTypeMap["campo5n"] = "String";
        ...
        model_internal::propertyTypeMap["campo4n"] = "String";
        ...
        model_internal::_selectedValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSelected);
        model_internal::_selectedValidator.required = true;
        model_internal::_selectedValidator.requiredFieldError = "selected is required";
        //model_internal::_selectedValidator.source = model_internal::_instance;
        //model_internal::_selectedValidator.property = "selected";
    ...
    public function invalidateDependentOnSelected():void
    {
        if (model_internal::_selectedIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSelected = null;
            model_internal::calculateSelectedIsValid();
        }
    }
    ...
    public function get selectedValidator() : StyleValidator
    {
        return model_internal::_selectedValidator;
    }

    model_internal function set _selectedIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_selectedIsValid;         
        if (oldValue !== value)
        {
            model_internal::_selectedIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "selectedIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get selectedIsValid():Boolean
    {
        if (!model_internal::_selectedIsValidCacheInitialized)
        {
            model_internal::calculateSelectedIsValid();
        ...
        return model_internal::_selectedIsValid;
    }

    model_internal function calculateSelectedIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_selectedValidator.validate(model_internal::_instance.selected)
        model_internal::_selectedIsValid_der = (valRes.results == null);
        model_internal::_selectedIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::selectedValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::selectedValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get selectedValidationFailureMessages():Array
    {
        if (model_internal::_selectedValidationFailureMessages == null)
            model_internal::calculateSelectedIsValid();

        return _selectedValidationFailureMessages;
    }

    model_internal function set selectedValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_selectedValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_selectedValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "selectedValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("selected"):
            {
                return selectedValidationFailureMessages;
            }
            case("campo3n"):
            {
