	...
	//conectamos con la mysql
		...
		for($ii = 0; $ii < $nn; $ii++){
			...
			if(count($formula1) > 1){
				switch($formula1[2]){
					case 'NN':						
						$comp1 = " AND x.tipo = 'TRIMESTRAL' ";
						break;
					case 'AN':
						$comp1 = " AND x.tipo = 'ANTERIOR' ";
						break;
					case 'AA':
						$comp1 = " AND x.tipo = 'ANUAL' ";
						break;
					case 'AC':
						$comp1 = " AND x.tipo = 'ACUMULADO' ";													  
						break;
					case 'AS':
						$comp1 = " AND 'QUERY' ";
						break;	
			...
			if(count($formula2) > 1){
				switch($formula2[2]){
					case 'NN':						
						$comp2 = " AND x.tipo = 'TRIMESTRAL' ";
						break;
					case 'AN':
						$comp2 = " AND x.tipo = 'ANTERIOR' ";
						break;
					case 'AA':
						$comp2 = " AND x.tipo = 'ANUAL' ";
						break;
					case 'AC':
						$comp2 = " AND x.tipo = 'ACUMULADO' ";													  
						break;
					case 'AS':
						$comp2 = " AND 'QUERY' ";
						break;	
			...
			if(count($formula3) > 1){
				switch($formula3[2]){
					case 'NN':						
						$comp3 = " AND x.tipo = 'TRIMESTRAL' ";
						break;
					case 'AN':
						$comp3 = " AND x.tipo = 'ANTERIOR' ";
						break;
					case 'AA':
						$comp3 = " AND x.tipo = 'ANUAL' ";
						break;
					case 'AC':
						$comp3 = " AND x.tipo = 'ACUMULADO' ";													  
						break;
					case 'AS':
						$comp3 = " AND 'QUERY' ";
						break;	
			...
			if(count($formula4) > 1){
				switch($formula4[2]){
					case 'NN':						
						$comp4 = " AND x.tipo = 'TRIMESTRAL' ";
						break;
					case 'AN':
						$comp4 = " AND x.tipo = 'ANTERIOR' ";
						break;
					case 'AA':
						$comp4 = " AND x.tipo = 'ANUAL' ";
						break;
					case 'AC':
						$comp4 = " AND x.tipo = 'ACUMULADO' ";													  
						break;
					case 'AS':
						$comp4 = " AND 'QUERY' ";
						break;	
			...
			if(count($formula5) > 1){
				switch($formula5[2]){
					case 'NN':						
						$comp5 = " AND x.tipo = 'TRIMESTRAL' ";
						break;
					case 'AN':
						$comp5 = " AND x.tipo = 'ANTERIOR' ";
						break;
					case 'AA':
						$comp5 = " AND x.tipo = 'ANUAL' ";
						break;
					case 'AC':
						$comp5 = " AND x.tipo = 'ACUMULADO' ";													  
						break;
					case 'AS':
						$comp5 = " AND 'QUERY' ";
						break;	
			...
			$sql = "SELECT b.id_indice_financiero, 
						d.id_empresa, 
						c.id_periodo,						
						(SELECT valor FROM valores x 
						 WHERE id_tag_agf = a.campo1 AND x.id_periodo = c.id_periodo AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp1 . ") C1,
						(SELECT valor FROM valores x 
						 WHERE id_tag_agf = a.campo2 AND x.id_periodo = c.id_periodo AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc2 " . $comp2 . ") C2,
						(SELECT valor FROM valores x 
						 WHERE id_tag_agf = a.campo3 AND x.id_periodo = c.id_periodo AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc3 " . $comp3 . ") C3,                        
						(SELECT valor FROM valores x 
						 WHERE id_tag_agf = a.campo4 AND x.id_periodo = c.id_periodo AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc4 " . $comp4 . ") C4,         
						(SELECT valor FROM valores x 
						 WHERE id_tag_agf = a.campo5 AND x.id_periodo = c.id_periodo AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc5 " . $comp5 . ") C5, 
						concat(d.rso, ': ', b.nombre), 
						label, 
						formula, 
						c.ano, 
					...
					WHERE b.id_indice_financiero = " . $ultimo_id . "
						;
					";  
		...
		for($j = 1; $j < count($f) ; $j++, $jj++){
			...
			while($row = $result->fetch_array(MYSQLI_NUM)){
				...
				$sql = "SELECT b.id_indice_financiero, 
						d.id_empresa, 
						c.id_periodo,						
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo1 AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp1 . ") C1,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo2 AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc2 " . $comp2 . ") C2,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo3 AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc3 " . $comp3 . ") C3,                        
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo4 AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc4 " . $comp4 . ") C4,         
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo5 AND id_empresa = d.id_empresa AND id_periodo = c.id_periodo AND origen = a.tipoc5 " . $comp5 . ") C5, 
						concat(d.rso, ': ', b.nombre), 
						label, 
						formula, 
						c.ano, 
						c.mes,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo1 AND id_empresa = " . $principal . " AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp1 . ") P1,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo2 AND id_empresa = " . $principal . " AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp2 . ") P2,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo3 AND id_empresa = " . $principal . " AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp3 . ") P3,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo4 AND id_empresa = " . $principal . " AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp4 . ") P4,
						(SELECT valor FROM valores x WHERE id_tag_agf = a.campo5 AND id_empresa = " . $principal . " AND id_periodo = c.id_periodo AND origen = a.tipoc1 " . $comp5 . ") P5,
						d.color, d.rso, b.nombre
					FROM formulas a
					   INNER JOIN indices_financieros b 
						ON a.id_indice_financiero = b.id_indice_financiero
